				...
				<form id="addemp" method="post">
					  ...
					  <div class="form-row">
						<div class="form-group col-md-6">
						  ...
						  <input type="tel" name="mobile" class="form-control" id="inputtel1" pattern="[1-9]{1}[0-9]{9}">
						</div>
						<div class="form-group col-md-6">
						  <label for="inputPassword4">Land-Line</label>
						  <input type="tel" name="landline" class="form-control" id="inputtel2" pattern="[1-9]{1}[0-9]{9}">
						</div>
					  </div>
